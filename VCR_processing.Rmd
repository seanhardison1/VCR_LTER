...
```{r sm_visualization, warning=FALSE, message=FALSE, echo = F, fig.width = 8, fig.cap="Mean abundance of unique house mice, rice rats, and Norway rats across sampling sites and through time. Regression line Shaded region shows +/- 1 SD."}
...
pal <- setNames(c('purple', 'orange', 'black'), levels(annual_by_group$Location))
